...
print.orcutt <- function(x, ...) {
    ...
    cat("\n number of interactions:" , x$number.interaction)
    ...
    cat("\n\nDurbin-Watson statistic \n(original):   ",
        format(round(x$DW[1], 5), nsmall = 5),
        ", p-value:", format(x$DW[2], scientific = TRUE, digits = 4))
    cat("\n(transformed):",
        format(round(x$DW[3], 5), nsmall = 5),
        ", p-value:", format(x$DW[4], scientific = TRUE, digits = 4))
